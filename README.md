# Hey, I'm Aakash Vaishnav 👋

**Product Manager 2 @ Microsoft** · Building things at the intersection of product thinking and code.

I ship side projects to scratch my own itches — AI tools, browser extensions, developer utilities, and anything that saves time or money.
...
| [HabitTracker](https://github.com/akshvaishnav21/HabitTracker) | Minimal PWA habit tracker with streaks | React, TypeScript, Drizzle ORM, Vite |
| [Pomodoro Timer](https://github.com/akshvaishnav21/pomodoro-timer) | Focus timer with tasks and stats | React, TypeScript, Zustand, Vite |
| [Folder Organizer](https://github.com/akshvaishnav21/folder-organizer) | Auto-organise Windows files by type and date | Python, tkinter |
...
**Data & AI:** Gemini AI · SQLite · Drizzle ORM
**Tools:** Docker · Vite · Chrome Extensions API · Claude Code
...
<!--
**akshvaishnav21/akshvaishnav21** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
